...
<div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8 relative">
    ...
    <h2 class="text-2xl font-bold text-gray-700 text-center mb-6 animate-fadeIn">Create an Account</h2>
    <p class="text-gray-500 text-center mb-8 animate-slideDown">Join us by filling the form below</p>
    <form method="POST" action="/register">
        ...
        <button type="submit" class="w-full mt-4 bg-gradient-to-r from-purple-500 to-blue-500 text-white py-2 rounded-md hover:from-purple-600 hover:to-blue-600 focus:outline-none focus:ring-4 focus:ring-purple-300 animate-pulse">Register</button>
    </form>
</div>
</body>
</html>
